...
/***/ (function(module, exports, __webpack_require__) {
	...
	var songEvents = __webpack_require__(35);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://intense-temple-94148.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(12);
	var showSearchJumboTemplate = __webpack_require__(14);
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  $('#leave').show();
	  $('.jumbotron').show();
	  var showSearchJumbo = showSearchJumboTemplate();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<!-- "
	    + ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + " -->\n<h1>Search</h1>\n<p>Click on the search button below to start picking your songs!</p>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showBarJumboTemplate = __webpack_require__(36);
	var showSearchJumboTemplate = __webpack_require__(14);
	var showYourJumboTemplate = __webpack_require__(37);
	...
	var onSearch = function onSearch() {
	  event.preventDefault();
	  $('.view').empty();
	  api.search().then(ui.searchSuccess).catch(ui.searchFailure);
	  $('.navi').removeClass('active');
	...
	var onBarList = function onBarList() {
	  event.preventDefault();
	  $('.view').empty();
	  api.barList().then(ui.barListSuccess).catch(ui.barListFailure);
	  $('.navi').removeClass('active');
	  $(this).addClass('active');
	  var showBarJumbo = showBarJumboTemplate();
	  $('.jumbotron').empty();
	  $('.jumbotron').append(showBarJumbo);
	};

	var onYourList = function onYourList() {
	  event.preventDefault();
	  $('.view').empty();
	  api.yourList().then(ui.yourListSuccess).catch(ui.yourListFailure);
	  $('.navi').removeClass('active');
	  $(this).addClass('active');
	  var showYourJumbo = showYourJumboTemplate();
	  $('.jumbotron').empty();
	...
	var onLeave = function onLeave() {
	  event.preventDefault();
	  $('.view').empty();
	  api.leave().then(ui.leaveSuccess).catch(ui.leaveFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<!-- "
	    + ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + " -->\n<h1>Moe's Tavern</h1>\n<p>View what songs are going to be played next and who picked 'em.</p>\n";
	},"usePartial":true,"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<!-- "
	    + ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + " -->\n<h1>Your Songs</h1>\n<p>See the songs you want to play and change them without losing your spot.</p>\n";
	},"usePartial":true,"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var chooseSong = function chooseSong(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/user_songs',
	    method: 'POST',
	    headers: {
	...
	var editSong = function editSong(data, rowToEdit) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showSongsTemplate = __webpack_require__(40);
	var showBarListTemplate = __webpack_require__(41);
	var showYourListTemplate = __webpack_require__(42);
	var dynamicSongEvents = __webpack_require__(43);

	var searchSuccess = function searchSuccess(data) {
	  var showSongsHtml = showSongsTemplate({ songs: data.songs });
	  $('.view').append(showSongsHtml);
	  $('.song').on('click', dynamicSongEvents.onChooseSong);
	};

	var searchFailure = function searchFailure(error) {
	  console.error('error is ', error);
	};

	var barListSuccess = function barListSuccess(data) {
	  var showBarListHtml = showBarListTemplate({ user_songs: data.user_songs });
	  $('.view').append(showBarListHtml);
	};

	var barListFailure = function barListFailure(error) {
	  console.error('bar list songs is NOT working and error is', error);
	};

	var yourListSuccess = function yourListSuccess(data) {
	  var showYourListHtml = showYourListTemplate({ user_songs: data.user_songs });
	  $('.view').append(showYourListHtml);
	  $('.edit').on('click', dynamicSongEvents.onUserChoiceEdit);
	};

	var yourListFailure = function yourListFailure(error) {
	  console.error('your list songs is NOT working and error is', error);
	};

	var leaveSuccess = function leaveSuccess(data) {
	  // const showYourListHtml = showYourListTemplate({ user_songs: data.user_songs })
	  // $('.view').append(showYourListHtml)
	};

	var leaveFailure = function leaveFailure(error) {
	...
	module.exports = {
	  ...
	  barListSuccess: barListSuccess,
	  barListFailure: barListFailure,
	  yourListSuccess: yourListSuccess,
	  yourListFailure: yourListFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- "
	    ...
	    + "\" class='row song col-lg-offset-1'>\n      <div class='col-lg-4 col-xs-4'>\n        "
	  ...
	  return "<div class='row headerz col-lg-offset-1'>\n  <h3 class='col-lg-4 col-xs-4'>Songs</h3>\n  <h3 class='col-lg-4 col-xs-4'>Artist</h3>\n  <h3 class='col-lg-3 col-xs-3'>Runtime</h3>\n</div>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.songs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- "
	    ...
	    + "\n      </div>\n      <div class='col-lg-3 col-xs-3'>\n          "
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.song : stack1)) != null ? stack1.runtime : stack1), depth0))
	    + "\n      </div>\n    </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class='row headerz col-lg-offset-1'>\n  <h3 class='col-lg-4 col-xs-4'>Songs</h3>\n  <h3 class='col-lg-4 col-xs-4'>Artist</h3>\n  <h3 class='col-lg-3 col-xs-3'>Runtime</h3>\n</div>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.user_songs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"usePartial":true,"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- "
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-default edit\" data-toggle=\"popover\" title=\"Edit Window\" data-content=\"You have an edit window open. Please choose a song to update to\" data-placement=\"bottom\" data-trigger=\"manual\">Edit</button>\n      </div>\n    </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class='row headerz'>\n  <h3 class='col-lg-4 col-xs-4' >Songs</h3>\n  <h3 class='col-lg-4 col-xs-3'>Artist</h3>\n  <h3 class='col-lg-3 col-xs-2'>Runtime</h3>\n</div>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.user_songs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"usePartial":true,"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var api = __webpack_require__(38);
	var dynamicUi = __webpack_require__(44);
	var store = __webpack_require__(12);

	var onChooseSong = function onChooseSong() {
	  ...
	  api.chooseSong(data).then(dynamicUi.chooseSongSuccess).catch(dynamicUi.chooseSongFailure);
	};

	// This is when a user clicks on the edit button to see the dropdown of songs
	var onUserChoiceEdit = function onUserChoiceEdit() {
	  var rowToEdit = $(this).attr('data-id');
	  if ($('.edit-song-pane').is(':visible')) {
	    $(this).popover('toggle');
	    $('[data-toggle="popover"]').not(this).popover('hide');
	  } else {
	    $(this).closest('.one-song').css('background-color', 'yellow');
	    api.search().then(dynamicUi.searchEditSuccess.bind(null, rowToEdit)).catch(dynamicUi.searchEditFailure);
	  }
	};

	module.exports = {
	  onChooseSong: onChooseSong,
	  onUserChoiceEdit: onUserChoiceEdit
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var searchEditTemplate = __webpack_require__(45);
	var editSongEvent = __webpack_require__(46);

	var chooseSongSuccess = function chooseSongSuccess(data) {
	  $('.add-animation').fadeIn();
	  $('.add-animation').fadeOut('slow');
	};

	var chooseSongFailure = function chooseSongFailure(error) {
	  console.error('choosing a song did not work and error is', error);
	};

	var searchEditSuccess = function searchEditSuccess(rowToEdit, data) {
	  $('.one-song').not('.one-song[data-id=' + rowToEdit + ']').css('background-color', 'white');
	  var searchEditHtml = searchEditTemplate({ songs: data.songs });
	  $('.one-song[data-id=' + rowToEdit + ']').append(searchEditHtml);
	  $('.edit-song').on('click', editSongEvent.onEdit);
	};

	var searchEditFailure = function searchEditFailure(error) {
	  console.error('looking for a new song is NOT working and error is', error);
	};

	module.exports = {
	  chooseSongSuccess: chooseSongSuccess,
	  chooseSongFailure: chooseSongFailure,
	  searchEditSuccess: searchEditSuccess,
	  searchEditFailure: searchEditFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class='container edit-song-pane col-lg-7 col-lg-offset-3 col-xs-12 well'>\n\n  <h4 class='col-lg-4 col-xs-4'>Songs</h4>\n  <h4 class='col-lg-4 col-xs-4'>Artist</h4>\n  <h4 class='col-lg-3 col-xs-3'>Runtime</h4>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.songs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</div>\n";
	},"usePartial":true,"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onEdit = function onEdit() {
	  ...
	  api.editSong(data, rowToEdit).then(editUi.editClickSongSuccess).catch(editUi.editClickSongFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showEditSongTemplate = __webpack_require__(48);

	var editClickSongSuccess = function editClickSongSuccess(data) {
	  var showEditSongHtml = showEditSongTemplate({ user_song: data.user_song });
	  $('.one-song[data-id=' + data.user_song.id + ']').append(showEditSongHtml);
	  $('[data-toggle="popover"]').popover('hide');
	};

	var editClickSongFailure = function editClickSongFailure(error) {
	  console.error('editting a song did not work and error is', error);
	};

	module.exports = {
	  editClickSongSuccess: editClickSongSuccess,
	  editClickSongFailure: editClickSongFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<!-- "
	    + ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + " -->\n<div class='col-lg-4 col-xs-4'>\n  "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.user_song : depth0)) != null ? stack1.song : stack1)) != null ? stack1.name : stack1), depth0))
	    + "\n</div>\n<div class='col-lg-4 col-xs-3'>\n    "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.user_song : depth0)) != null ? stack1.song : stack1)) != null ? stack1.artist : stack1), depth0))
	    + "\n</div>\n<div class='col-lg-3 col-xs-2'>\n    "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.user_song : depth0)) != null ? stack1.song : stack1)) != null ? stack1.runtime : stack1), depth0))
	    + "\n</div>\n<div class='col-lg-1 col-xs-2'>\n  <button type=\"button\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.user_song : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-default edit\" disabled=\"disabled\">Edit</button>\n</div>\n";
	},"usePartial":true,"useData":true});
